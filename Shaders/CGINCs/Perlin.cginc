#ifndef PERLIN_SHADER_LOGIC
#define PERLIN_SHADER_LOGIC

float GetPerlin(float3 position, float seed, float frequency, float lacunarity, float persistence, float octaves)
{
    float value = 0.0;
    float signal = 0.0;
